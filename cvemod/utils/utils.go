...
var (
	...
	VulLIst         = [...]string{"struts2-001", "struts2-005", "struts2-007", "struts2-008", "struts2-009", "struts2-012", "struts2-013", "struts2-015", "struts2-016", "struts2-045", "struts2-046", "struts2-048", "struts2-053", "struts2-057"}
...
func PocS005Exec(command string) string {
...
func PocS007Exec(command string) string {
...
func PocS008Exec(command string) string {
...
func PocS009Exec(param string, command string) string {
...
func PocS012Exec(command string) string {
...
func PocS013Exec(command string) string {
	command = url.QueryEscape(command)
...
func PocS015Exec(command string) string {
...
func PocS016Exec(command string) string {
	command = url.QueryEscape(command)
...
func PocS048Exec(command string) string {
...
func PocS053Exec(command string) string {
...
func PocS057Exec(command string) string {
...
func PocS059Exec(command string) string {
...
func colorPrint() {
	log.Printf("%v %v", Green("http://127.0.0.1"), Red("*Found Struts2-001！"))
	log.Printf("%s Struts2-001 Not Vulnerable.", Green("http://192.168.1.1"))
}
